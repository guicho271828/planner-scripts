(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-4) (:DOMAIN CELL-ASSEMBLY)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 B-2 B-3 - BASE PART-A PART-B PART-C -
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (AT B-3 CARRY-IN) (FINISHED NOTHING-DONE B-3) (FREE ARM1) (AT ARM1 TRAY-A)
