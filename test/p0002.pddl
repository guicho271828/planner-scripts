(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-2) (:DOMAIN CELL-ASSEMBLY)
 (:OBJECTS ARM1 ARM2 - ARM B-0 B-1 - BASE PART-A PART-B PART-C - COMPONENT
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE ARM1 GASKET-MACHINE)
  ...
  (FINISHED NOTHING-DONE B-1) (FREE ARM1) (AT ARM1 TRAY-A) (ARM-PRESENT TRAY-A)
  (FREE ARM2) (AT ARM2 OILING-MACHINE) (ARM-PRESENT OILING-MACHINE))
 (:GOAL
  (AND (AT B-0 CARRY-OUT) (FINISHED INSPECT-BASE B-0) (AT B-1 CARRY-OUT)
       (FINISHED INSPECT-BASE B-1)))
