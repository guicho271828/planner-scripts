...
test-non-ff (){
    ...
    success ../limit.sh -v -- $1 p03.pddl domain.pddl
    ...
    fail ../limit.sh -v -- $1 unsolvable.pddl domain.pddl
...
for planner in  jasper mercury ff lpg marvin1 marvin2 mpc mp m probe yahsp3
do
